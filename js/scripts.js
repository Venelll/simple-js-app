...
for (var i = 0; i < repository.length; i++) {
  document.write("Name: ", repository[i].name, "<br>", "Height: ", repository[i].height," meters", "<br>", "Typing: ",
                 repository[i].typing, "<br>", "Pokedex Number: ", repository[i].pokedexNumber, "<p>")
